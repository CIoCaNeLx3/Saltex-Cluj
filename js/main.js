$(function () {
    ...
    //open search pop-up when span is clicked
    $(".open").on("click", function(e) { //with event now
        var $modal = $("#blabla");
        $modal.show();
    });

    // close search pop-up when click out of pop-up area
    $(document).on('click', function(event) {
        if (!$(event.target).closest('#blabla').length) {
          // Hide the menus.
          closeSearch();
        }
      });
    ...
    //close search pop-un on escape key pressed
